...
public class DataReportServiceUnitTests
{
    ...
    //private readonly Mock<IEmployeeRoleService> _roleService;
    ...
    //    _roleService = new Mock<IEmployeeRoleService>();
    //    _service = new DataReportService(_db.Object, _helper.Object, _roleService.Object);
    //}
    ...
    //    var result = await _service.GetDataReportList(new AuthorizeIdentity
    //    {
    //        Role = "",
    //        Email = "",
    //        NameIdentifier = ""
