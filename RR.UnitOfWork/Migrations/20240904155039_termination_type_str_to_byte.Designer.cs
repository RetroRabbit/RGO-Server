...
namespace RR.UnitOfWork.Migrations
{
    ...
    [Migration("20240904155039_termination_type_str_to_byte")]
    partial class termination_type_str_to_byte
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RR.UnitOfWork.Entities.HRIS.EmployeeRole", b =>
                {
                    b.HasOne("RR.UnitOfWork.Entities.HRIS.Employee", "Employee")
                        ...
                        .HasForeignKey("RR.UnitOfWork.Entities.HRIS.EmployeeRole", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
