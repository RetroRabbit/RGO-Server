...
namespace RGO.App.Tests.Controllers
{
    public class EmployeeEvaluationTemplateItemControllerUnitTests
    {
        ...
        public async Task GetAllEmployeeEvaluationTemplateItemsValidSectionReturnsOkResult()
        {
            ...
            {
                new EmployeeEvaluationTemplateItemDto(1, new EmployeeEvaluationTemplateDto(101, "Template 1"), section, "Question 1"),
                new EmployeeEvaluationTemplateItemDto(2, new EmployeeEvaluationTemplateDto(102, "Template 2"), section, "Question 2"),
            };
            ...
            var result = await controller.GetAllEmployeeEvaluationTemplateItems(section, template: null);
            ...
            Assert.All(actualTemplateItems, item =>
            {
        ...
        public async Task GetAllEmployeeEvaluationTemplateItemsValidTemplateReturnsOkResult()
        {
            ...
            var expectedTemplateItems = new List<EmployeeEvaluationTemplateItemDto>
            {
                new EmployeeEvaluationTemplateItemDto(1, new EmployeeEvaluationTemplateDto(101, template), "Section 1", "Question 1"),
                new EmployeeEvaluationTemplateItemDto(2, new EmployeeEvaluationTemplateDto(102, template), "Section 2", "Question 2"),
            };
            ...
            var result = await controller.GetAllEmployeeEvaluationTemplateItems(section: null, template);
            ...
            Assert.All(actualTemplateItems, item =>
            {
                Assert.Equal(template, item.Template?.Description);
            });
        }
        ...
        public async Task GetAllEmployeeEvaluationTemplateItemsNoSectionOrTemplateReturnsOkResult()
        {
            var expectedTemplateItems = new List<EmployeeEvaluationTemplateItemDto>
            {
                new EmployeeEvaluationTemplateItemDto(1, new EmployeeEvaluationTemplateDto(101, "Template 1"), "Section 1", "Question 1"),
                new EmployeeEvaluationTemplateItemDto(2, new EmployeeEvaluationTemplateDto(102, "Template 2"), "Section 2", "Question 2"),
            };
            ...
            var result = await controller.GetAllEmployeeEvaluationTemplateItems(section: null, template: null);
        ...
        {
            var serviceMock = new Mock<IEmployeeEvaluationTemplateItemService>();
            serviceMock.Setup(x => x.GetAll()).ThrowsAsync(new Exception("An error occurred while retrieving employee evaluation template items."));
        ...
        public async Task SaveEmployeeEvaluationTemplateItemValidParametersReturnsOkResult()
        {
            ...
            var savedEmployeeEvaluationTemplateItem = new EmployeeEvaluationTemplateItemDto(1, new EmployeeEvaluationTemplateDto(101, template), section, question);
        ...
        {
            var validDto = new EmployeeEvaluationTemplateItemDto(1, new EmployeeEvaluationTemplateDto(101, "Example Test Template"), "Example Section", "Example Question");
        ...
        {
            var invalidDto = new EmployeeEvaluationTemplateItemDto(1, new EmployeeEvaluationTemplateDto(101, "Example Test Template"), "Example Section", "Example Question");
        ...
        public async Task DeleteEmployeeEvaluationTemplateItemValidParametersReturnsOkResult()
        {
            ...
            serviceMock.Setup(x => x.Delete(template, section, question))
                       .ReturnsAsync(new EmployeeEvaluationTemplateItemDto(1, new EmployeeEvaluationTemplateDto(101, "Example Test Template"), "Example Section", "Example Question"));
