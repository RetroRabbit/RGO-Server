...
public class EmployeeEvaluationRatingControllerUnitTests
{
    ...
    {
        var evaluationInput = new EmployeeEvaluationInput(null, "owner@retrorabbit.co.za", "employee@test.com", "Template 1", "Subject 1");
        ...
        var expectedRatings = new List<EmployeeEvaluationRatingDto>
        {
            new EmployeeEvaluationRatingDto(
                ...
                new EmployeeEvaluationDto(
                    101,
                    new EmployeeDto(201, "EMP123", "123456", DateTime.Now, DateTime.Now.AddMonths(6), 1, false, "No disability", 2,
                        new EmployeeTypeDto(1, "Regular"), "Some notes", 25.0f, 20.0f, 50.0f, 50000, "John Doe", "JD", "Doe",
                        DateTime.Parse("1990-01-01"), "South Africa", "South African", "ID123456", "PP789012",
                        ...
                        new EmployeeAddressDto(401, "Unit123", "ComplexXYZ", "1234", "SuburbABC", "City123", "South Africa",
                            "ProvinceXYZ", "12345"),
                        new EmployeeAddressDto(402, "Unit456", "Complex123", "5678", "SuburbXYZ", "City456", "South Africa",
                            "ProvinceABC", "67890"), "123 Main St", "Emergency Contact", "+9876543210"),
                    new EmployeeEvaluationTemplateDto(301, "Template1"), new EmployeeDto(1, "EMP123", "123456", DateTime.Now,
                        DateTime.Now.AddMonths(6), 1, false, "No disability", 2, new EmployeeTypeDto(1, "Regular"),
                        "Some notes", 25.0f, 20.0f, 50.0f, 50000, "John Doe", "JD", "Doe", DateTime.Parse("1990-01-01"),
                        "South Africa", "South African", "ID123456", "PP789012", DateTime.Now.AddYears(5), "South Africa",
                        Race.Black, Gender.Male, "photo.jpg", "john.doe@example.com", "john.doe.personal@example.com",
                        "+1234567890", 3, 2, new EmployeeAddressDto(401, "Unit123", "ComplexXYZ", "1234", "SuburbABC",
                            "City123", "South Africa", "ProvinceXYZ", "12345"),
                        new EmployeeAddressDto(402, "Unit456", "Complex123", "5678", "SuburbXYZ", "City456", "South Africa",
                            "ProvinceABC", "67890"), "123 Main St", "Emergency Contact", "+9876543210"), "Subject1",
                        DateOnly.FromDateTime(DateTime.Now), null),
                    new EmployeeDto(1, "EMP123", "123456", DateTime.Now, DateTime.Now.AddMonths(6), 1, false, "No disability",
                        2, new EmployeeTypeDto(1, "Regular"), "Some notes", 25.0f, 20.0f, 50.0f, 50000, "John Doe", "JD",
                        "Doe", DateTime.Parse("1990-01-01"), "South Africa", "South African", "ID123456", "PP789012",
                        DateTime.Now.AddYears(5), "South Africa", Race.Black, Gender.Male, "photo.jpg",
                        "john.doe@example.com", "john.doe.personal@example.com", "+1234567890", 3, 2,
                        new EmployeeAddressDto(401, "Unit123", "ComplexXYZ", "1234", "SuburbABC", "City123", "South Africa",
                            "ProvinceXYZ", "12345"),
    ...
    {
        var evaluationInput = new EmployeeEvaluationInput(null, "owner@retrorabbit.co.za", "employee@retrorabbit.co.za", "Template 1", "Subject 1");

        var ratingInput = new EvaluationRatingInput(1, "test@retrorabbit.co.za", evaluationInput, "Test Description", 5.0f, "Test Comment");

        var serviceMock = new Mock<IEmployeeEvaluationRatingService>();

        var employeeDto = new EmployeeDto(201, "EMP123", "123456", DateTime.Now, DateTime.Now.AddMonths(6), 1, false, "No disability", 2,
                        new EmployeeTypeDto(1, "Regular"), "Some notes", 25.0f, 20.0f, 50.0f, 50000, "John Doe", "JD", "Doe",
                        DateTime.Parse("1990-01-01"), "South Africa", "South African", "ID123456", "PP789012",
                        DateTime.Now.AddYears(5), "South Africa", Race.Black, Gender.Male, "photo.jpg",
                        "john.doe@example.com", "john.doe.personal@example.com", "+1234567890", 3, 2,
        ...
        var savedRating = new EmployeeEvaluationRatingDto(1,
            new EmployeeEvaluationDto(201, employeeDto, templateDto, employeeDto, "Subject 1", DateOnly.FromDateTime(DateTime.Now), null),
    ...
    {
        var ratingInput = new EvaluationRatingInput(1, "test@retrorabbit.co.za", null, "Test Description", 5.0f, "Test Comment");

        var serviceMock = new Mock<IEmployeeEvaluationRatingService>();
        serviceMock.Setup(x => x.Save(ratingInput)).ThrowsAsync(new Exception("An error occurred while saving the employee evaluation rating."));
    ...
    {
        var evaluationInput = new EmployeeEvaluationInput(101, "owner@retrorabbit.co.za", "employee@retrorabbit.co.za", "Template 1", "Subject 1");
        var ratingInput = new EvaluationRatingInput(1, "test@retrorabbit.co.za", evaluationInput, "Updated Description", 4.5f, "Updated Comment");
    ...
    public async Task UpdateEmployeeEvaluationRatingExceptionThrownReturnsNotFoundResult()
    {
        ...
        var serviceMock = new Mock<IEmployeeEvaluationRatingService>();
        serviceMock.Setup(x => x.Update(ratingInput)).ThrowsAsync(new Exception("An error occurred while updating the employee evaluation rating."));
    ...
    public async Task DeleteEmployeeEvaluationRatingExceptionThrownReturnsNotFoundResult()
    {
        ...
        var serviceMock = new Mock<IEmployeeEvaluationRatingService>();
        serviceMock.Setup(x => x.Delete(ratingInput)).ThrowsAsync(new Exception("An error occurred while deleting the employee evaluation rating."));
