...
namespace RGO.App.Tests.Controllers
{
    public class AuthenticationControllerUnitTests
    {
        ...
        public async Task LoginUserUserNotFoundReturnsNotFoundResult()
        {
            ...
            string userEmail = "nonexistent@retrorabbit.co.za";
        ...
        public async Task RegisterEmployeeValidInputReturnsCreatedAtActionResult()
        {
            ...
            authServiceMock.Setup(x => x.RegisterEmployee(newEmployee)).ReturnsAsync("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");
        ...
        public async Task GetUserRolesSuccessReturnsOkResult()
        {
            ...
            {
                new Claim(ClaimTypes.Email, "test@retrorabbit.co.za")
            }));
            ...
            authServiceMock.Setup(a => a.GetUserRoles(It.IsAny<string>())).ReturnsAsync(new Dictionary<string, List<string>>());
        ...
        public async Task GetUserRoles_ReturnsOkResult_WithEmail()
        {
            ...
            authServiceMock.Setup(a => a.GetUserRoles("test@retrorabbit.co.za")).ReturnsAsync(new Dictionary<string, List<string>>());
        ...
        public async Task GetUserRolesReturnsNotFoundResult()
        {
            ...
            authServiceMock.Setup(x => x.GetUserRoles(It.IsAny<string>())).ThrowsAsync(new Exception("Exception occurred while getting user roles"));
            ...
            if (result is NotFoundObjectResult notFoundResult)
            {
                ...
                string actualErrorMessage = notFoundResult.Value.ToString();
