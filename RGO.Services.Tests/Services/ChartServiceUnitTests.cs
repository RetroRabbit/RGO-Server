    ...
    public class ChartServiceUnitTests
    {
        ...
        public async Task CreateChartTest()
        {
            ...
            EmployeeDto employeeDto = new(1, "001", "34434434", new DateTime(), new DateTime(),
               null, false, "None", 4, developerEmployeeTypeDto, "Notes", 1, 28, 128, 100000, "Dotty", "D",
            ...
            EmployeeDto desEmployeeDto = new(1, "001", "34434434", new DateTime(), new DateTime(),
               null, false, "None", 4, designerEmployeeTypeDto, "Notes", 1, 28, 128, 100000, "Dotty", "D",
               "Missile", new DateTime(), "South Africa", "South African", "0000000000000", " ",
               new DateTime(), null, Models.Enums.Race.Black, Models.Enums.Gender.Female, null,
               "dm@retrorabbit.co.za", "test@gmail.com", "0123456789", null, null, employeeAddressDto, employeeAddressDto, null, null, null);
            ...
            {
                 new Employee(employeeDto,developerEmployeeTypeDto),
                new Employee(desEmployeeDto,designerEmployeeTypeDto)
            };
        ...
        public async Task CreateChartTestAll()
        {
            ...
            EmployeeDto employeeDto = new(1, "001", "34434434", new DateTime(), new DateTime(),
               null, false, "None", 4, devEmployeeTypeDto, "Notes", 1, 28, 128, 100000, "Dotty", "D",
               "Missile", new DateTime(), "South Africa", "South African", "0000000000000", " ",
               new DateTime(), null, Models.Enums.Race.Black, Models.Enums.Gender.Female, null,
               "dm@retrorabbit.co.za", "test@gmail.com", "0123456789", null, null, employeeAddressDto, employeeAddressDto, null, null, null);
            EmployeeDto desEmployeeDto = new(1, "001", "34434434", new DateTime(), new DateTime(),
               null, false, "None", 4, desEmployeeTypeDto, "Notes", 1, 28, 128, 100000, "Dotty", "D",
               "Missile", new DateTime(), "South Africa", "South African", "0000000000000", " ",
               new DateTime(), null, Models.Enums.Race.Black, Models.Enums.Gender.Female, null,
               "dm@retrorabbit.co.za", "test@gmail.com", "0123456789", null, null, employeeAddressDto, employeeAddressDto, null, null, null);
            ...
            var employeeList = new List<Employee>
            {
                 new Employee(employeeDto,devEmployeeTypeDto),
                new Employee(desEmployeeDto,desEmployeeTypeDto)
            };
        ...
        {
            var chartDtoToUpdate = new ChartDto(Id: 1,
                Name: "Update",
                Type: "Pie",
                DataTypes: new List<string> { "Gender", "Race" },
                Labels: new List<string> { "Male", "Female" },
        ...
        public async Task ExportCsvAsyncTest()
        {
            var employeeDto = new EmployeeDto(1, "001", "34434434", new DateTime(), new DateTime(),
                1, false, "None", 3, employeeTypeDto1, "Notes", 1, 28, 128, 100000, "Estiaan", "MT",
            ...
            var expectedResult = new byte[] {70,105,114,115,116,32,78,97,109,101,44,76,97,115,116,32,78,97,109,101,
                44,65,103,101,44,71,101,110,100,101,114,44,82,97,99,101,13,10,69,115,116,105,97,97,110,44,66,114,105,
        ...
        public async Task ExportCsvAsyncTestFail()
        {
            ...
            var exception = await Assert.ThrowsAsync<Exception>(
                async () => await chartService.ExportCsvAsync(dataTypeList));
