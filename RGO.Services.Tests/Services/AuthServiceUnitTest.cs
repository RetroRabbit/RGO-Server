    ...
    public class AuthServiceUnitTest
    {
        ...
        public async Task CheckUserExist()
        {
            ...
            var employeeDtoList = new List<Employee> {
                new Employee (employeeDto, employeeTypeDto1)
            };

            _unitOfWork.Setup(r => r.Employee.Get(It.IsAny<Expression<Func<Employee, bool>>>())).Returns(employeeDtoList.AsQueryable().BuildMock());
        ...
        public async Task Login()
        {
            ...
            _unitOfWork.Setup(x => x.Employee.Get(It.IsAny<Expression<Func<Employee, bool>>>())).Returns(employeeDtoList.AsQueryable().BuildMock());
        ...
        {
            var email = "dm@retrorabbit.co.za";
            var expectedRoles = new Dictionary<string, List<string>> { { "Admin", new List<string> { "Create", "Read", "Update", "Delete" } } };
